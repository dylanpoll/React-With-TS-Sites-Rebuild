...
tdlr
  user data generated(logs in) -> redis assigned session -> cookie key created with secrete -> cookie updated with current cookie key
  request made(userid or is authenticated?) -> cookie key -> redis session key -> requested user data
